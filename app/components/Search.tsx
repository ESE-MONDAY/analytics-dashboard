...
const SearchBar: React.FC = () => {
  ...
  return (
    <div className="hidden lg:flex py-1.5 items-center border-[1px] w-full border-[#A3A3A3]  h-auto lg:w-[349px] rounded-full px-2">
      ...
      <input
        type="text"
        placeholder="Search..."
        className="flex-grow p-2  focus:outline-none bg-transparent font-normal text-sm"
        value={searchQuery}
