  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        <main className="flex min-h-screen max-w-[1440px] mx-auto w-screen  ">
          <aside className="py-5 px-2.5 hidden  bg-[#F7F8FA] border-r-[1px] border-r-[#EBECF2] md:flex flex-col gap-5">
            <div className=" p-2.5 ">
            ...
            <Link href="/" className="flex items-center p-2.5">
              ...
              {/* Icon 3 */}
              <Link href="/" className="flex items-center justify-center p-2.5">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
